 ...
 * }
 *
 * Table annotation may be found at #{{@link com.basilgregory.finotes_orm.annotations.Table}}.
 *
 */
public abstract class Entity implements Serializable{
    ...
    /**
     * This function needs to be called in the class where @DB #{{@link com.basilgregory.finotes_orm.annotations.DB}}
    ...
    public void save(){
        if (id > 0){
            DBExecutor.getInstance().update(this);
        }else{
            DBExecutor.getInstance().insert(this);
        }
    }
     ...
     */
    public static Entity findById(Class entityClass,long id){
        return DBExecutor.getInstance().findById(entityClass,id);
     ...
     */
    public static Entity findByUniqueProperty(Class entityClass,String columnName,Object value){
        return DBExecutor.getInstance().findByUniqueProperty(entityClass,columnName,value);
    }
